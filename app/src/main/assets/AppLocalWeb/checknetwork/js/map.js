...
;!function(win, $, undefined){
    ...
    var SVGMap = (function(){
        function SVGMap(dom, options){
            ...
            var colorRed = 'ff5955';
            var colorYellow = 'ffe074';
            var colorGreen = '69d463';
        ...
        SVGMap.prototype.options = {
            ...
            mapWidth: 500,
            mapHeight: 400,
            stateColorList: [colorRed, colorYellow, colorGreen],
            ...
            stateInitColor: '69d463',
            stateHoverColor: '0000FF',
            stateSelectedColor: '0000FF',
