...
//平滑滚动，无限循环，可封装成View
public class ViewPagerBannerActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initView() {
        ...
        //设置当前viewpager要显示第几个条目,实现向左还可以滑动
    ...
    private void initViewPagerData() {
        ...
        int imgIds[] = {R.mipmap.anminal1, R.mipmap.cheese_4, R.mipmap.cheese_5, R.mipmap.photo_1};
        ImageView iv;
        View dotView;
