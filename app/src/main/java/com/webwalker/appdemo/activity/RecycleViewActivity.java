...
import com.webwalker.framework.widget.recycle.SmartRecyclerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RecyclerView.Adapter<ViewHolder>() {
            ...
            public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                CardView cardView = new CardView(RecycleViewActivity.this);
                ...
                TextView textView = new TextView(RecycleViewActivity.this);
