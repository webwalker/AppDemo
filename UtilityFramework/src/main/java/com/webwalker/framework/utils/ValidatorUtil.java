...
public class ValidatorUtil {
	...
	/**
	 * 判断金额的格式: isAmount(".89") = true isAmount(".898") = false isAmount("3.98")
	 * = true isAmount(".8") = true isAmount("22") = true isAmount("22.00")=
	 * true
	 * 
	 * @param amount
	 * @return
	...
	public static boolean isAmount(String amount) {
		if (StringUtil.isNotBlank(amount)) {
			if (amount.trim().indexOf("") != -1) {
				String ext = amount.trim()
						.substring(amount.trim().indexOf(""));
