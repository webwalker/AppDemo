...
public class ShrinkView extends View {
    ...
    private ShrinkDrawable mIndicator;
...
//        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ShrinkView, defStyleAttr, 0);
//        mMinWidth = a.getDimensionPixelSize(R.styleable.ShrinkView_minWidth2, mMinWidth);
//        mMaxWidth = a.getDimensionPixelSize(R.styleable.ShrinkView_maxWidth2, mMaxWidth);
//        mMinHeight = a.getDimensionPixelSize(R.styleable.ShrinkView_minHeight2, mMinHeight);
//        mMaxHeight = a.getDimensionPixelSize(R.styleable.ShrinkView_maxHeight2, mMaxHeight);
//        mIndicatorColor = a.getColor(R.styleable.ShrinkView_indicatorColor2, Color.WHITE);
        setShrink(new ShrinkDrawable());
        //a.recycle();
    }

    private void setShrink(ShrinkDrawable d) {
        if (mIndicator != d) {
            if (mIndicator != null) {
