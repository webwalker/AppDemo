package com.webwalker.framework.widget.guideview;
...
public class GuideView extends View {
    ...
    private void drawCanvas(GuideItem gi) {
        ...
        switch (gi.getTargetShape()) {
            case Rectangle:
                Log.d("GuideView", "Rectangle drawing...");
            ...
            case CornerRectangle:
                ...
                break;
            case Circle:
                Log.d("GuideView", "Circle drawing...");
    ...
    private void setPositionAnim(GuideItem gi) {
        ...
        Log.d("GuideView", "setPositionAnim:" + top + "," + bottom);
        // 出场动画
    ...
    public boolean haShowOver() {
        if (guideItems == null || guideItems.size() == 0)
            return true;
        return currentIndex >= guideItems.size();
    }
